<div id="navigation" class="admin-nav">
    ...
    <div class="float-right" style="position: absolute;right: 50px;top: 20px;">
        ...
        <a href="https://rightsignature.com/login" target="_blank" style="text-decoration:none;"><img height="24" width="24" src="http://www.forcremation.com/images/right.png"> Right Signature</a> &nbsp;
